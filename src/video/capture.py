...
class VideoSource:
    ...
    def _configure_v4l2(capture: cv2.VideoCapture) -> None:
        ...
        # Единственный подтверждённый полный режим данного EasyCap: 720x480
        # при 25 fps. Это ограничение устройства, не частота NTSC источника.
